...
import { Compass, Instagram, Phone, MapPin, MessageCircle, Heart, Mail } from 'lucide-react';
import { useApp } from '../context/AppContext';

export const Footer: React.FC = () => {
  const { businessInfo } = useApp();
  const waUrl = `${businessInfo.waBaseUrl}?text=${encodeURIComponent("Halo Lombok Journey, saya tertarik untuk bertanya tentang liburan ke Lombok.")}`;
  const mailUrl = `mailto:${businessInfo.email}?subject=${encodeURIComponent("Inquiry Tour Paket Lombok Journey")}`;
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-10 pb-12 border-b border-white/10">
          ...
          <div className="lg:col-span-5 space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-12 h-12 rounded-full bg-white p-0.5 shadow-md overflow-hidden flex items-center justify-center">
                <img
                  src="/logo.svg"
              ...
              <div className="flex flex-col">
                <span className="font-playfair text-2xl font-bold text-white tracking-tight leading-tight">
                  Lombok Journey
                </span>
            ...
            <p className="text-xs sm:text-sm text-slate-300 font-light leading-relaxed max-w-md">
              Agensi Tour & Travel lokal resmi spesialis Experience Trip, Escape Trip, Adventure Trip, dan Gili Escape Trip di Pulau Lombok. Melayani dengan keramahan khas Sasak, armada aman, dan kebebasan atur itinerary.
            </p>
            ...
            <div className="pt-2 flex items-center gap-3">
              ...
              <a
                href={mailUrl}
                className="w-10 h-10 rounded-xl bg-white/10 hover:bg-[#D4AF37] hover:text-[#112D4E] text-white flex items-center justify-center transition-all"
                aria-label="Email Inquiry Lombok Journey"
              >
          ...
          <div className="lg:col-span-3 space-y-3">
            ...
            <ul className="space-y-2 text-xs sm:text-sm font-light">
              ...
              <li>
                <a href="#dokumentasi" className="hover:text-[#D4AF37] transition-colors">Dokumentasi Real</a>
              </li>
              <li>
          ...
          <div className="lg:col-span-4 space-y-3">
            ...
            <div className="space-y-3 text-xs sm:text-sm font-light">
              ...
              <a
                ...
                className="flex items-start gap-3 hover:text-[#D4AF37] transition-colors group"
              >
                <Mail className="w-5 h-5 text-[#30E3CA] shrink-0 mt-0.5" />
                <div>
                  <span className="block text-slate-400 text-[11px]">Email Inquiry</span>
                  <span className="font-semibold text-white group-hover:text-[#D4AF37]">
                    {businessInfo.email}
                  </span>
                </div>
