      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center md:text-left pt-12 md:pt-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          ...
          <div className="lg:col-span-8 space-y-6">
            ...
            {/* Tagline Badge */}
            <div className="inline-flex items-center gap-2.5 bg-white/10 backdrop-blur-md border border-[#30E3CA]/40 px-4 py-2 rounded-full text-xs sm:text-sm font-medium text-white shadow-xl">
              <img
                src="/logo.svg"
                alt="Lombok Journey"
