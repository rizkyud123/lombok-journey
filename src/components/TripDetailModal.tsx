...
import { X, CheckCircle, Clock, MapPin, Sparkles, MessageCircle, AlertCircle } from 'lucide-react';
      ...
      >
        ...
        <div className="p-6 overflow-y-auto space-y-6 text-slate-700">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-4 bg-[#F5F5F5] rounded-2xl border border-slate-200">
            <div>
              <p className="text-xs text-slate-500 font-medium uppercase tracking-wide">Estimasi Biaya Paket</p>
              <p className="text-xl font-extrabold text-[#112D4E]">{service.priceStart}</p>
            </div>
          ...
          <div>
            <h4 className="font-playfair font-bold text-lg text-[#112D4E] mb-3 flex items-center gap-2">
              ...
              Pilihan Rute Spot Destinasi Favorit
            </h4>
          ...
          <div className="p-3.5 bg-amber-50 rounded-2xl border border-amber-200 text-xs text-amber-900 flex items-start gap-2.5">
            ...
            <p>
              <strong>Catatan:</strong> Rute destinasi dan jadwal waktu penjemputan dapat disesuaikan penuh sesuai jam kedatangan tiket pesawat atau jadwal kapal Anda.
            </p>
          </div>
        ...
        <div className="p-4 sm:p-6 bg-slate-50 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-3 shrink-0">
          ...
          <a
            ...
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-[#D4AF37] hover:bg-[#b8952b] text-[#112D4E] font-bold text-sm px-6 py-3 rounded-full shadow-lg transition-colors"
          >
            <MessageCircle className="w-5 h-5 fill-current" />
            <span>Pesan Paket {service.title} via WA</span>
          </a>
        </div>
