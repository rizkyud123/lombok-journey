...
export const AdminDashboard: React.FC = () => {
  ...
  const handleVideoUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      reader.onload = () => {
        ...
        showNotification('File video berhasil dimuat & siap diputar di aplikasi!');
      };
      reader.onerror = () => {
  ...
  const handleSaveGallery = (e: React.FormEvent) => {
    ...
    const payload: GalleryActivity = {
      ...
      videoUrl: isVideo ? galleryForm.videoUrl : undefined,
    ...
    if (isAddingGallery) {
      ...
      showNotification(`${isVideo ? 'Video trip' : 'Foto'} baru berhasil disimpan dan disinkronkan ke server global!`);
    } else if (editingGallery) {
      updateGalleryActivity(editingGallery.id, payload);
      showNotification(`${isVideo ? 'Video trip' : 'Foto'} galeri berhasil diperbarui di server global!`);
    }
