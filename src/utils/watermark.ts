...
export async function stampWatermarkToImage(
  ...
  return new Promise((resolve, reject) => {
    ...
    img.onload = () => {
      // Create canvas with maximum dimension 1600px for high quality & smooth local storage storage
      let width = img.width;
      ...
      // Convert to compressed web-friendly JPEG data URL (quality 0.88)
      try {
