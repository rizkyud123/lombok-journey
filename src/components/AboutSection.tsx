      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-4">
          ...
          <p className="text-base sm:text-lg text-slate-600 font-light leading-relaxed">
            <strong className="font-semibold text-[#112D4E]">{BUSINESS_INFO.name}</strong> hadir sebagai mitra perjalanan terpercaya di Pulau Lombok. Kami berkomitmen memberikan pengalaman perjalanan yang menyenangkan lewat pelayanan hangat khas Sasak.
          </p>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center relative z-10">
            <div className="lg:col-span-7 space-y-5">
              ...
              <div className="pt-4 flex items-center gap-4">
                <a
                  href={`${BUSINESS_INFO.waBaseUrl}?text=${encodeURIComponent("Halo Lombok Journey, saya ingin konsultasi rencana liburan.")}`}
                  target="_blank"
